...
_custom_encoder_function: Callable[
    [Any], Any
] = pyctor.defaults.default_custom_encoder_function
_custom_decoder_function: Callable[
    [Type, Any], Any
] = pyctor.defaults.default_custom_decoder_function

_default_encoder: msgspec.msgpack.Encoder = msgspec.msgpack.Encoder(
    enc_hook=pyctor.multiprocess.messages.encode_func(func=_custom_encoder_function)
)
...
def set_custom_encoder_function(func: Callable[[Any], Any]) -> None:
    ...
    _default_encoder = msgspec.msgpack.Encoder(
        enc_hook=pyctor.multiprocess.messages.encode_func(func=func)
    )
